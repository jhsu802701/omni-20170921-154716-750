...
group :development, :testing do
  ...
  gem 'rubocop', '0.50.0' # Checks for violations of the Ruby Style Guide, not recommended for legacy apps
  gem 'sandi_meter', '1.2.0'
end

# Minitest
gem 'minitest', '5.10.3', require: false, group: :testing
gem 'minitest-reporters', '1.1.18', require: false, group: :testing # Adds special features to tests
...
group :test, :development do
  ...
  gem 'ruby-progressbar', '1.8.3' # Provides a progress bar to be used during long loop actions
end
